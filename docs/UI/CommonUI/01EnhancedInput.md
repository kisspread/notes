...
![alt text](../../assets/images/01EnhancedInput_image.webp)
...
![usersettting](../../assets/images/EnhancedInput_image.webp)
...
- NavBarPriority 用于ActionBar的排序，Router会收集所有活动的Action，然后通知`UCommonBoundActionBar::HandleDeferredDisplayUpdate()`进行更新
  ![alt text](../../assets/images/EnhancedInput_image-1.webp) 
- bIsGenericInputAction 如果是通用输入，则不会注入 普通enhanced input的逻辑，具体代码在 `auto TryConsumeInput = [&](const FKey& InKey, const UInputAction* InInputAction)`
    ![alt text](../../assets/images/EnhancedInput_image-2.webp)
    也就是widget里 自定义的enhanced input action不会被系统触发。
    ![alt text](../../assets/images/EnhancedInput_image-6.webp)

- 这里还有配置全局的默认值，也是非常重要不指定的话，就会采用默认值的设定：
  ![alt text](../../assets/images/01EnhancedInput_image-8.webp)
...
![alt text](../../assets/images/01EnhancedInput_image-10.webp)
...
![alt text](../../assets/images/01EnhancedInput_image-11.webp)
保持默认行为，不要单独配置按钮的模式如下图。保持默认行为好理解，不然一套规则的排列组合下来，还是挺烦人的。
![alt text](../../assets/images/01EnhancedInput_image-12.webp)
...
例子,这两个IA都绑定了E 键：
![alt text](../../assets/images/01EnhancedInput_image-14.webp)
![alt text](../../assets/images/01EnhancedInput_image-13.webp)
它们都能输出。
...
![alt text](../../assets/images/01EnhancedInput_image-2.webp)
那么这些Node是何时创建的？
...
- tree 根构造
  ![alt text](../../assets/images/01EnhancedInput_image-4.webp)


- tree添加子节点
  ![alt text](../../assets/images/01EnhancedInput_image-5.webp)
 
### LeafmostNode 
最叶节点

   从代码上看，最叶节点，可以是本身（没有child），也可以是最边缘的节点。在视觉和逻辑层次上最靠近叶子节点的节点。通过 GetLastPaintLayer 来判断节点的层次，层次越大表示越靠近叶子节点   
   ![alt text](../../assets/images/01EnhancedInput_image-6.webp)  

根据Node改变FUIInputConfig,node 的input config 在这里切换
![alt text](../../assets/images/01EnhancedInput_image-7.webp)

## Process Input

处理输入，就是通过节点树来处理的，只有激活的才有资格处理。
![alt text](../../assets/images/01EnhancedInput_image-3.webp)
上面提到的TryConsumeInput是`FActionRouterBindingCollection::ProcessNormalInput`的临时内部函数，这里的处理比较复杂，尝试记录一下我的理解

### Input 的来源

Enhanced 默认调用链：
![alt text](../../assets/images/01EnhancedInput_image-15.webp)

通过CommonUI注册的，调用链完全不同，[预处理器](#analogcursor)：

- 键盘输入：从application 一路去到 GameViewPort Client, 最终由 ActionRouter 进行最后的分发
  ![alt text](../../assets/images/EnhancedInput_image-3.webp)
- 鼠标输入：大致相同
  ![alt text](../../assets/images/EnhancedInput_image-4.webp)
- 手柄输入：
  ![alt text](../../assets/images/EnhancedInput_image-5.webp)

  参考官方图，简化流程：
  ![alt text](../../assets/images/01EnhancedInput_image-1.webp)
...
![alt text](../../assets/images/01EnhancedInput_image-16.webp)

### EnhancedInput 
hard coding -1， 这个是EnhancedInputWorldSubsystem，我的测试里，它没有调用。
![alt text](../../assets/images/01EnhancedInput_image-17.webp)
...
![alt text](../../assets/images/01EnhancedInput_image-18.webp)
...
![alt text](../../assets/images/EnhancedInput_image-8.webp)

另外，CommonBaseButton 可以对自身绑定的InputMode进行覆盖
![alt text](../../assets/images/EnhancedInput_image-7.webp)
...
![alt text](../../assets/images/EnhancedInput_image-9.webp)
按下按键的时候，由ViewPort接受事件，调用ActionRouter进行处理 `UCommonGameViewportClient::HandleRerouteInput`
![alt text](../../assets/images/EnhancedInput_image-12.webp)
...
![alt text](../../assets/images/EnhancedInput_image-11.webp)

 Press和 Release的Input Action 大体上相同，只是入口不一样，下图是Pressed 和 Relased最开始的地方。调用ProcessKeyDownEvent 和 ProcessKeyUpEvent 分别处理。
![FSlateApplication::OnControllerButtonPressed](../../assets/images/EnhancedInput_image-13.webp)
...
![alt text](../../assets/images/EnhancedInput_image-10.webp)
...
- 为什么修改了Enhance default Click Action ，只有图标改变，Action 还是 Faceb Button Bottom ? 
  ![alt text](../../assets/images/EnhancedInput_image-14.webp)
...
- 为什么图标更新了？这不是说明能拿到 default Click Action吗？
  ...
  ![alt text](../../assets/images/EnhancedInput_image-15.webp)
...
- 为什么Enhanced Input 作为 Trigger Action的时候，Hold 无法正确生效？
    ...
    ![alt text](../../assets/images/EnhancedInput_image-16.webp)
    ...
    ![alt text](../../assets/images/EnhancedInput_image-17.webp)
